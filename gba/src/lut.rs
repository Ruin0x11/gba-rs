...
#[inline]
pub fn sin(theta: usize) -> Fixed {
    Fixed::from_bits(SIN_LUT[(theta >> 7) & 0x1FF] as i32)
}

#[inline]
pub fn cos(theta: usize) -> Fixed {
    Fixed::from_bits(SIN_LUT[((theta >> 7) + 128) & 0x1FF] as i32)
}
